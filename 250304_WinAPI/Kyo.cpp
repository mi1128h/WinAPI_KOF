...
void Kyo::Init()
{
    ...
    if (FAILED(idleImages->Init(L"ImageKyo/Kyo_Idle.bmp", 200*10, 200, 10, 1, true, RGB(255, 0, 255)))) {
    ...
    if (FAILED(walkImages->Init(L"ImageKyo/Kyo_Walk.bmp", 200*5, 200, 5, 1, true, RGB(255, 0, 255)))) {
    ...
    if (FAILED(strongPunchImages->Init(L"ImageKyo/Kyo_strongPunch.bmp", 200*8, 200, 8, 1, true, RGB(255, 0, 255)))) {
    ...
    if (FAILED(weakPunchImages->Init(L"ImageKyo/Kyo_weakPunch.bmp", 200*5, 200, 5, 1, true, RGB(255, 0, 255)))) {
    ...
    if (FAILED(strongKickImages->Init(L"ImageKyo/Kyo_strongKick.bmp", 200*11, 200, 11, 1, true, RGB(255, 0, 255)))) {
    ...
    if (FAILED(weakKickImages->Init(L"ImageKyo/Kyo_weakKick.bmp", 200*9, 200, 9, 1, true, RGB(255, 0, 255)))) {
